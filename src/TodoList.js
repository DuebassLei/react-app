...
class TodoList extends Component {
  ...
  handleInputChange(e) {
    ...
    // 改用下方es6写法，返回一个函数 this.setState({     inputValue: e.target.value })
  ...
  handleBtnClick() {
    // this.setState({     //添加数据 list:[...this.state.list,this.state.inputValue],
    //   //清空数据     inputValue:'' }) this.setState可以接收一个参数，修改之前的参数
